...
class KeyboardOverlayService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_DESCRIPTION =
            "Persistent while the Mapo keyboard overlay is active."
        private const val NOTIFICATION_ID = 0x4D70 // "Mp"
        private const val NOTIFICATION_TITLE = "Mapo keyboard overlay"
        private const val NOTIFICATION_TEXT = "Tap the Mapo Quick Settings tile to hide."
    }
}
