 ...
 * activator-settings cog -> [com.mappo.ui.screen.ActivatorEditorScreen]).
 *
...
fun ModeSettingsScreen(
    ...
    onBack: () -> Unit,
    capturedInputs: kotlinx.coroutines.flow.SharedFlow<com.mappo.service.input.InputAddress>,
