 ...
 *
 * **Why a separate constant table** (not just [com.mappo.data.model.steam.InputSource]'s
 ...
 * [com.mappo.service.shizuku.ShizukuMotionStream], the service side just emits IDs.
 *
