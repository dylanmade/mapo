...
import com.mappo.service.input.CompiledActivatorSettings
 ...
 * writes through to the repo. No draft / Save / Cancel layer — the rest of Mappo's editing
...
private fun findActivatorContext(
    ...
    fun resolve(graph: com.mappo.data.model.steam.ActivatorGraph): ActivatorContext {
    ...
    fun scan(groups: Sequence<com.mappo.data.model.steam.BindingGroupGraph>): ActivatorContext? {
        for (group in groups) {
