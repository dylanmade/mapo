...
interface InputSink {
     ...
     * by [com.mappo.service.input.modes.MouseRegionMode]; the velocity-based
     ...
     * display, or null if it can't be determined or matches Mappo itself. Implemented via
...
/**
 * Hilt-managed bridge between the [com.mappo.service.InputAccessibilityService] and the
