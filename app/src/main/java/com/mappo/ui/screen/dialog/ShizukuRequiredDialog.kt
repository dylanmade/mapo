package com.mappo.ui.screen.dialog
 ...
 * the body recomposes.
 *
 * **Ack semantics.** Confirming routes the user to [com.mappo.ui.screen.ShizukuSetupScreen]
 * AND persists the ack (via [com.mappo.data.settings.ShizukuRequiredPreferences])
