 ...
 * into typed records.
 *
 * This is the *first half* of VDF import: pure restructuring with **no Mappo
 ...
 * / `Activator` / `Binding` and decides mode-token → [com.mappo.data.model.steam.BindingMode],
 ...
 * "Soft_Press"`); translation to Mappo enums happens downstream so the mapping
