...
import com.mapo.ui.component.colorpicker.ColorPickerButton
import com.mapo.ui.component.colorpicker.MapoColorPickerDialog

/**
 * Dev harness for the new [MapoColorPickerDialog]. Demonstrates the intended integration: a
...
fun ColorPickerDemoScreen(onBack: () -> Unit) {
    ...
    when (editing) {
        0 -> MapoColorPickerDialog(
            initialColor = fill,
            title = "Fill color",
            onConfirm = { fill = it; editing = null },
            onDismiss = { editing = null },
        )
        1 -> MapoColorPickerDialog(
            initialColor = accent,
            title = "Accent color",
            onConfirm = { accent = it; editing = null },
            onDismiss = { editing = null },
        )
        2 -> MapoColorPickerDialog(
            initialColor = tint,
            title = "Overlay tint",
