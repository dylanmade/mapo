 ...
 * three share the `mappo_uinput.so` build.
 *
 ...
 * caller (`MappoInputUserService.injectStylusAbsolute`) passes the live
...
object UinputStylus {
     ...
     * by the kernel but a defensive clamp here keeps Mappo's bookkeeping
     * predictable.
     */
