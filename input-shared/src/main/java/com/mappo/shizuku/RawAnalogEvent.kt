 ...
 * [com.mappo.service.shizuku.ShizukuMotionStream] which converts to `AnalogReading`
 * and hands to `InputEvaluator.handleAnalogReadings`.
 *
 * @param sourceOrdinal Ordinal of [com.mappo.data.model.steam.InputSource] in :app.
