...
import com.mappo.ui.screen.BottomBar
import com.mappo.ui.screen.KeyGrid
import com.mappo.ui.screen.KeyboardSurface
import com.mappo.ui.screen.KeyboardTopBar
 ...
 * mode, run-only).
 *
 * Pulls run-mode state out of [state] (typically a [com.mappo.service.keyboard.KeyboardController]
 ...
 *    "Open Mappo" affordance (TODO: visual polish lands in Brick 4).
