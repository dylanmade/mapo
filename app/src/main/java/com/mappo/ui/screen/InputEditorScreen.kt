...
import com.mappo.data.model.steam.findGroupInput
 ...
 * is intentionally absent — Mappo expresses soft-pull behavior via the trigger's
 ...
 * routed via [TriggerMode][com.mappo.service.input.modes.TriggerMode]'s soft-threshold
